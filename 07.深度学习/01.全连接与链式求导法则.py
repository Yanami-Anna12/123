...
def foward(w11_1, b1_1, w12_1, b2_1, w11_2, w21_2, b1_2, X):
    z1_1 = w11_1 * X + b1_1
    a1_1 = sigmoid(z1_1)
...
for epoch in range(1, epoches+1):
    a1_1, a2_1, a1_2 = foward(w11_1, b1_1, w12_1, b2_1, w11_2, w21_2, b1_2, X)
    ...
    if epoch == 1 or epoch % 100 == 0:
        ...
        _, _, y_values = foward(w11_1, b1_1, w12_1, b2_1, w11_2, w21_2, b1_2, x_values)
        plt.clf()
        plt.subplot(2, 1, 1)
